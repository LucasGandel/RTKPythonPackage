...
$env:Path += ";C:\P\grep"
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/InsightSoftwareConsortium/ITKPythonPackage/master/scripts/internal/wheel_builder_utils.py" -OutFile "wheel_builder_utils.py"
C:\Python35-x64\python.exe windows-build-module-wheels.py